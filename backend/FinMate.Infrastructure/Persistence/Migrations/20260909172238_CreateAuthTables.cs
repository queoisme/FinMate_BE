        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    scheduled_hard_delete_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("chk_data_deletion_requests_status", "status IN ('pending','processed')");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    mission_reminders_enabled = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "idx_data_deletion_requests_scheduled_hard_delete_at",
                table: "data_deletion_requests",
                column: "scheduled_hard_delete_at");
