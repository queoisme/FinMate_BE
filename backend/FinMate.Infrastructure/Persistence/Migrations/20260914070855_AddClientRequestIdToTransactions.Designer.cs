...
namespace FinMate.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260914070855_AddClientRequestIdToTransactions")]
    partial class AddClientRequestIdToTransactions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinMate.Domain.Entities.BudgetPeriod", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("Alert70SentAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("alert_70_sent_at");

                    b.Property<DateTimeOffset?>("Alert90SentAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("alert_90_sent_at");
            ...
            modelBuilder.Entity("FinMate.Domain.Entities.DataDeletionRequest", b =>
                {
                    ...
                    b.ToTable("data_deletion_requests", null, t =>
                        {
                            t.HasCheckConstraint("chk_data_deletion_requests_status", "status IN ('pending','processed','cancelled')");
                        });
                });

            modelBuilder.Entity("FinMate.Domain.Entities.DeviceToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("FinMate.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.HasIndex("CounterAccountId")
                        .HasDatabaseName("idx_transactions_counter_account_id");
                    ...
                    b.ToTable("transactions", null, t =>
                        {
                            t.HasCheckConstraint("chk_transactions_source", "source IN ('notification','manual','voice','receipt')");
                            ...
                            t.HasCheckConstraint("chk_transactions_transfer_shape", "(transaction_type = 'transfer' AND counter_account_id IS NOT NULL AND counter_account_id <> financial_account_id AND category_id IS NULL) OR (transaction_type <> 'transfer' AND counter_account_id IS NULL)");
                        });
                });
            ...
            modelBuilder.Entity("FinMate.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<long?>("MonthlyIncomeCents")
                        .HasColumnType("bigint")
                        .HasColumnName("monthly_income_cents");
            ...
            modelBuilder.Entity("FinMate.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.HasOne("FinMate.Domain.Entities.FinancialAccount", "CounterAccount")
                        .WithMany()
